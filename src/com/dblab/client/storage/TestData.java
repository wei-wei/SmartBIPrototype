...
public class TestData {
	private final AqlMember[] regionMember
		= {new AqlMember("Afria", 0, 0, 1), new AqlMember("Asia", 0, 2, 4), new AqlMember("Europe", 0, 5, 10),
		   new AqlMember("North America", 0, 11, 13), new AqlMember("Oceania", 0, 14, 14), 
		   new AqlMember("South America", 0, 15, 16)};
	...
	private final AqlMember[] countryMember
		= {new AqlMember("Egypt", 0, 0, 0), new AqlMember("South Africa", 0, 1, 1), new AqlMember("China", 1, 2, 2),
		   ...
		   new AqlMember("Germany", 2, 6, 6), new AqlMember("Intaly", 2, 7, 7), new AqlMember("Russia", 2, 8, 8),
	...
	private final AqlMember[] cityMember
		= {new AqlMember("Cairo", 0, 0, 0), new AqlMember("Pretoria", 1, 1, 1), new AqlMember("Beijing", 2, 2, 2),
		   ...
		   new AqlMember("Buenos Aires", 15, 15, 15), new AqlMember("Brasilia", 5, 16, 16)};
